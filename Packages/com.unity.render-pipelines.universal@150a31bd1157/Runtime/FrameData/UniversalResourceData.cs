...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class UniversalResourceData : UniversalResourceDataBase
    {
        ...
        {
            get => CheckAndGetTextureHandle(ref _depthHandle);
            set => CheckAndSetTextureHandle(ref _depthHandle, value);
        }
        private TextureHandle[] _depthHandle = new TextureHandle[12];

        public TextureHandle[] colorHandle
        {
            get => CheckAndGetTextureHandle(ref _colorHandle);
            set => CheckAndSetTextureHandle(ref _colorHandle, value);
        }
        private TextureHandle[] _colorHandle = new TextureHandle[12];
